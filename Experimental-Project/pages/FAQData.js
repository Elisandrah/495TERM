...
/*   {
  ...
  //Use Unicode \n\u2b24 to render a bullet point.
  //If an answer has multiple paragraphs, paste the next paragraph on the next line with a \n before it.
  //Note: You MUST enclose the answer with back quotes (``) for it to work! Not '' or "".
  {
  ...
  },
  {
    ...
    data: [
      ...
      {
        id: 'Coronavirus2',
        question: "How does COVID-19 affect pregnant women?",
